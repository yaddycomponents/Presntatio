...
export function Shell({ section, bg, children }) {
  return (
    ...
    >
      ...
      >
        <div
          style={{ width: 28, height: 28, borderRadius: 8, background: t.ai }}
        />
        <div style={{ height: 6 }} />
        {[0, 1, 2, 3, 4, 5, 6].map((i) => (
          <div
            ...
            style={{
              ...
              borderRadius: 7,
              background:
                i === 1 ? "rgba(255,255,255,0.18)" : "rgba(255,255,255,0.07)",
            }}
          />
        ))}
      </div>
        ...
        >
          ...
          >
            {section && (
              <>
                <span
                  style={{ fontSize: 14, color: t.muted, whiteSpace: "nowrap" }}
                >
                  {section}
                </span>
